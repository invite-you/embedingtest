...
각 클러스터는 대표 문장과 앞뒤 한 줄씩의 문맥(기본 설정)을 포함하므로,
터미널에서 곧바로 “대표 문장 ±1줄” 형식을 확인할 수 있습니다.
...
* `--config`로 `config/agent.yaml` 외의 설정 파일을 지정하면 문장 수 제한, 컨텍스트 윈도우 크기 등을 즉시 바꿀 수 있습니다.
